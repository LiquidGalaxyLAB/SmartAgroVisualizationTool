...
def addPointToTour(playlist, coordinates, placemark_id):
    ...
    flyTo(playlist, latitude, longitude, 1000, 5000, 5.0, 0)
...
def flyTo(playlist, latitude, longitude, altitude, pRange, duration, tilt=77):
...
def rotate(playlist, latitude, longitude, altitude, pRange):
